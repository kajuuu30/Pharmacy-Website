            ...
            <div class="row contact-form py-lg-5">
                ...
                <div class="col-lg-6 wthree-form-left mt-lg-0 mt-3">
                    ...
                    <div class="contact-top1">
                        ...
                        <form action="#" method="post" class="f-color pt-3">
                            <div class="form-group">
                                <label for="contactusername">Name</label>
                                <input type="text" name="user" class="form-control" id="contactusername" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="text" class="form-control" rows="5" id="contactcomment" required></textarea>
                            </div>
                            <button type="submit" name="sub" class="btn btn-danger btn-block">Submit</button>
                        </form>
