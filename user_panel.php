		...
		<div class="container">
			...
			<div class="cpy-right text-center  pt-3">
				...
				<div class="copyrightbottom">
					<p class="text-secondary">© 2021 Alleviating. All rights reserved | Design by
						<a href="http://w3layouts.com" class="text-white"> kajal yadav.</a>
					</p>
				</div>
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="validationDefault02" placeholder="" required="" name="email">
                            </div>

                            <div class="form-group">
                                <label class="mb-2 col-form-label">Password</label>
                                <input type="password" class="form-control" id="password1" placeholder="" required="" name="pwd">
                            </div>
                            <div class="form-group">
                                <label class="col-form-label">Confirm Password</label>
                                <input type="password" class="form-control" id="password2" placeholder="" required="" name="confirm">
                            </div>
							<div class="form-group">
                                <label class="col-form-label">Contact number</label>
                                <input type="number" class="form-control" id="validationDefault03" placeholder="" required="" name="contact">
                            </div>
							<div class="form-group">
                                <label class="col-form-label">City</label>
                                <input type="text" class="form-control" id="validationDefault04" placeholder="" required="" name="city">
                            </div>
							<div class="form-group">
                                <label class="col-form-label">DOB</label>
                                <input type="date" class="form-control" id="validationDefault02" placeholder="" required="" name="birthday">
                            </div>
							<div class="form-group">
                                <label class="col-form-label">State</label>
                                <input type="text" class="form-control" id="validationDefault05" placeholder="" required="" name="state">
                            </div>
							<div class="form-group">
                                <label class="col-form-label">Address</label>
                                <input type="text" class="form-control" id="validationDefault06" placeholder="" required="" name="add">
                            </div>
							<div class="reg-w3l">
								<button type="submit" name="sub' class="form-control submit mb-4">Register</button>
                           </div>
